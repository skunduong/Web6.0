...
else if(Nakama.keyboard.isDown(Phaser.Keyboard.DOWN) && Nakama.player.position.y <= 880){
Nakama.player.position.y += 10;
}
if(Nakama.keyboard.isDown(Phaser.Keyboard.LEFT) && Nakama.player.position.x >= 0){
Nakama.player.position.x -= 10;
}
else if(Nakama.keyboard.isDown(Phaser.Keyboard.RIGHT) && Nakama.player.position.x  <= 560){
Nakama.player.position.x += 10;
}
}
